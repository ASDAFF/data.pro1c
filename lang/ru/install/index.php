...
$MESS ['IMPORT_PRO1C_INSTALL_TITLE'] = "Установка модуля «Продвинутый обмен с 1С»";
$MESS ['IMPORT_PRO1C_UNINSTALL_TITLE'] = "Удаление модуля «Продвинутый обмен с 1С»";

$MESS ['IMPORT_PRO1C_INSTALL_TABLE_ERROR'] = "Ошибка при создании таблиц";
$MESS ['IMPORT_PRO1C_ONLY_MYSQL_ERROR'] = "Модуль работает только с базой данных MySQL";
$MESS ['IMPORT_PRO1C_SAVE_COMPONENTS'] = "Сохранить все компоненты связанные с модулем";
$MESS ['IMPORT_PRO1C_SAVE_DATABASE_SETTINGS_OF_MODULE'] = "Сохранить настройки связанные с модулем";
$MESS ['IMPORT_PRO1C_BUTTON_DELETE_COMPONENTS'] = "Удалить";

$MESS ['IMPORT_PRO1C_SETTINGS_PAGE'] = "Страница настроек";
